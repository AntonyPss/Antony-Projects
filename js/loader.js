...
function setupProject(project) {
    ...
    detailsContainer.innerHTML = `
      ...
      <div class="details-item">
        <div class="details-content">
          ...
          <div class="details-info">
            <p>Works with version <strong>${project.versionSupport}</strong>. Other versions lower than <strong>${project.versionNotSupport}</strong> may not be compatible.</p>
          </div>
        </div>
      </div>
      <div class="details-item">
        <div class="details-content">
          ...
          <div class="details-info">
            <p>Did you find a bug? You can help me improve it by reporting it.</p>
          </div>
        </div>
      </div>
    `;
    ...
    container.innerHTML = project.screenshots
        .map(
            (screenshot) => `
        <div class="card-item">
  ...
  `
    ...
    downloads.innerHTML = project.downloads
        .map(
            (download) => `
            <a href="${
                download.url
            }" target="_blank" class="download-card ${download.name.toLowerCase()}">
